  ...
  return (
    <>
      <Panel>
        ...
        <textarea className="mt-2 h-20 w-full resize-none border border-border bg-background p-2 text-[12px] outline-none focus:border-gold-dim" value={beat} onChange={(e) => setBeat(e.target.value)} />
